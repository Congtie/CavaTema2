"""
Run YOLOv8 inference and save results in the same format as the original solution.
This allows using evalueaza_solutie.py for evaluation.
"""
...
# Output paths (same as original solution)
...
def run_inference(input_folder, model_path=None, conf_threshold=0.25):
    """
    Run YOLO inference on images and save results in evaluation format.
    
    Args:
        input_folder: Path to folder with test images
        model_path: Path to trained YOLO model (default: best.pt from training)
